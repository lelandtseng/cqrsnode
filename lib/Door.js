...
// it is lib door, outside only use it proxy use lib.
//@param queryBus_ is a QueryBus
function Door(queryBus_,commandBus_,eventBus_,DB_){
...
// when domain ok!
this.onInited = function(handle){
    DB.on('complete',handle);
}
